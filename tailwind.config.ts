  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        /* IAZIS brand direct-access tokens */
        iz: {
          blue: "var(--iz-signal-blue)",
          cyan: "var(--iz-cyan-accent)",
          eclipse: "var(--iz-dark-eclipse)",
          surface: "var(--iz-surface)",
          "surface-2": "var(--iz-surface-2)",
          soft: "var(--iz-signal-soft)",
          light: "var(--iz-wordmark-light)",
          gray: "var(--iz-mid-gray)",
          dim: "var(--iz-dim)",
          snow: "var(--iz-snow)",
        },
