...
export const SEGMENT_TEMPLATES: Record<string, SegmentTemplate> = {
  saude: {
    ...
    warm_threshold: 40,
    criteria: [
      { id: uuid(), label: 'Tem WhatsApp Business ativo', type: 'boolean', weight: 20, positive_values: ['true', 'sim'] },
      { id: uuid(), label: 'Quantidade de atendentes', type: 'scale', weight: 18, scale_min: 1, scale_max: 10 },
      { id: uuid(), label: 'Volume mensal de mensagens', type: 'multiple_choice', weight: 16, options: ['Até 500', '500-2000', '2000-5000', 'Acima de 5000'] },
      { id: uuid(), label: 'Já perdeu pacientes por demora', type: 'boolean', weight: 14, positive_values: ['true', 'sim'] },
      { id: uuid(), label: 'Orçamento disponível', type: 'scale', weight: 15, scale_min: 1, scale_max: 5 },
      { id: uuid(), label: 'Número de unidades/filiais', type: 'scale', weight: 10, scale_min: 1, scale_max: 10 },
      { id: uuid(), label: 'Experiência com automação', type: 'boolean', weight: 7, positive_values: ['true', 'sim'] },
    ],
    funnel_stages: [
  ...
  outro: {
    ...
    warm_threshold: 35,
    criteria: [
      { id: uuid(), label: 'Usa WhatsApp para atendimento', type: 'boolean', weight: 20, positive_values: ['true', 'sim'] },
      { id: uuid(), label: 'Volume de atendimentos/mês', type: 'scale', weight: 18, scale_min: 1, scale_max: 10 },
      { id: uuid(), label: 'Tem equipe dedicada a vendas', type: 'boolean', weight: 16, positive_values: ['true', 'sim'] },
      { id: uuid(), label: 'Ticket médio da operação', type: 'multiple_choice', weight: 15, options: ['Até R$500', 'R$500-2000', 'R$2000-10000', 'Acima de R$10000'] },
      { id: uuid(), label: 'Urgência em resolver o problema', type: 'scale', weight: 15, scale_min: 1, scale_max: 5 },
      { id: uuid(), label: 'Orçamento disponível', type: 'scale', weight: 10, scale_min: 1, scale_max: 5 },
      { id: uuid(), label: 'Decisor presente na conversa', type: 'boolean', weight: 6, positive_values: ['true', 'sim'] },
    ],
    funnel_stages: [
      { name: 'Prospecção', color: '#60a5fa', sla_days: 3 },
      { name: 'Qualificado', color: '#a78bfa', sla_days: 5 },
