...
export const SEGMENT_TEMPLATES: Record<string, SegmentTemplate> = {
  ...
  educacao: {
    ...
    warm_threshold: 38,
    criteria: [
      { id: uuid(), label: 'Número de alunos ativos', type: 'scale', weight: 20, scale_min: 1, scale_max: 10, hint: 'Escala de 1 a 10 — volume de alunos. Ex.: 1 = até 50, 10 = acima de 5.000.' },
      { id: uuid(), label: 'Usa WhatsApp para comunicação', type: 'boolean', weight: 18, positive_values: ['true', 'sim'], hint: 'Sim ou Não — se a instituição já usa WhatsApp para falar com alunos/responsáveis.' },
      { id: uuid(), label: 'Frequência de matrículas/mês', type: 'multiple_choice', weight: 16, options: ['Até 10', '10-50', '50-200', 'Acima de 200'], hint: 'Selecione a faixa de novas matrículas mensais.' },
      { id: uuid(), label: 'Time de atendimento dedicado', type: 'boolean', weight: 15, positive_values: ['true', 'sim'], hint: 'Sim ou Não — se há equipe dedicada ao atendimento de alunos.' },
      { id: uuid(), label: 'Orçamento para tecnologia', type: 'scale', weight: 14, scale_min: 1, scale_max: 5, hint: 'Escala de 1 a 5 — disposição para investir em ferramentas digitais.' },
      { id: uuid(), label: 'Modalidade', type: 'multiple_choice', weight: 10, options: ['Presencial', 'Online', 'Híbrida'], hint: 'Selecione o formato de ensino predominante da instituição.' },
      { id: uuid(), label: 'Já usou chatbot ou automação', type: 'boolean', weight: 7, positive_values: ['true', 'sim'], hint: 'Sim ou Não — se já experimentou chatbot ou automação de mensagens.' },
    ],
    funnel_stages: [
