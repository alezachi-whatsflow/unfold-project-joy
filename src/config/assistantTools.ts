    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          attendee_emails: { type: "array", items: { type: "string" }, description: "Emails dos participantes (para criar evento no Google Calendar)" },
          duration_minutes: { type: "integer", description: "Duracao em minutos (padrao: 30)" },
          add_meet_link: { type: "boolean", description: "Criar link do Google Meet automaticamente" },
        },
