      ...
      <CardContent className="p-3 space-y-2">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-1.5 flex-1 min-w-0">
            {(activity as any).gcal_synced && (
              <svg className="h-3.5 w-3.5 shrink-0" viewBox="0 0 24 24" title="Sincronizado com Google Calendar">
            ...
            <h4 className="text-sm font-medium text-foreground leading-tight truncate">{activity.title}</h4>
          </div>
