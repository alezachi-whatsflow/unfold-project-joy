...
const SKILLS: SkillDef[] = [
  ...
  },
  {
    ...
    tagline: "Reconhece recibos e lanca despesas automaticamente",
    description: "Recebe foto de recibo via WhatsApp, extrai dados com Vision AI e lanca a despesa automaticamente no sistema.",
    price: 79,
    stage: "Estagio 4 — Automacao financeira",
    icon: <Receipt className="h-6 w-6" />,
    color: "text-emerald-500",
    features: [
      "OCR via Vision AI (GPT-4o / Claude)",
      "Extracao: fornecedor, valor, data, categoria",
      "Confirmacao automatica via WhatsApp",
      "Anexo salvo no armazenamento (R2)",
      "Lancamento direto na guia Despesas",
    ],
    limit: "Requer conexao WhatsApp ativa e bucket R2 configurado.",
  },
];
